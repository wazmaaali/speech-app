...
class CardNavigation extends Component {
  ...
  onSubmit = () => {
    if (this.state.cardsCompleted + 1 < this.state.numCards) {
      ...
      date = moment().tz("America/Chicago").format("MMMM Do, YYYY");
      saveDateOfLastCompletedTest(date);

      this.props.navigation.navigate("Info", {
        messageTitle: "Recording Completed",
        message:
          "Thank you for recording your speech samples. Your recordings have been successfully sent to our research team.",
      });
    }
  };
